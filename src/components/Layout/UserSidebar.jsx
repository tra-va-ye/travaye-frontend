  ...
  return (
    <Dashboard showDashboard={showDashboard}>
      <div className='relative'>
        {updatingPhoto && <Spin className='absolute bottom-[50%] left-[50%]' />}
      ...
      <div className='mb-3 -mt-2'>
        ...
        <p className='mt-0'>
          {userInfo?.occupation || 'No Occupation Provided'}
        </p>
      </div>
      <div>
        <div className='px-3'>
        ...
        <div className='mt-4'>
          ...
          <h6>
            {userInfo?.numberOfVisits ||
              `${userInfo?.numberOfVisits} Outings` ||
              'None'}
          </h6>
        </div>
        <div className='mt-4'>
